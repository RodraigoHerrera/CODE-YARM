...
<body>
    <div class="w-full h-screen  bg-gradient-to-tr from-[#05107f] via-[#5230a3] via-[#8852c7] to-[#bd77ed] flex  items-center justify-center ">
        <div
            ...
            <div class="w-full items-center justify-center flex">
                <ul
                    ...
                    <li>
                        ...
                        <p>patricia.quezada.s@gmail.com</p>
                    </li>
                    <li>
                        <svg
                        id="map"
                        ...
                        <p>C. 2 de la Barqueta 82, Achumani, La Paz</p>
                    </li>
                    <li>
                        <div class="flex items-center justify-center">
                            <a href="https://www.facebook.com/Entumesacakesandfood" 
                            class="relative flex items-center px-4 py-2 text-lg font-semibold text-[#0163E0] border border-[#0163E0] rounded-full overflow-hidden transition-colors duration-300 ease-out hover:text-white focus:outline-none">
                                <svg viewBox="0 0 16 16" class="h-6 w-6 fill-current transition-colors duration-300 ease-out">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
                                </svg>
                                <span class="ml-2">Facebook</span>
                                <span class="absolute inset-0 bg-[#0163E0] rounded-full scale-[20] opacity-0 transition-transform duration-500 ease-out hover:opacity-100 hover:scale-100"></span>
                            </a>
                        </div>
                    </li>
                </ul>
